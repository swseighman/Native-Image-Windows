...
6. Open the Visual Studio Installer
   	...
   	![](../Pictures/Screenshot 2020-11-30 120751.png)


7. Under the ‘**Installed**’ tab, click on the ‘**Modify**’ button and choose ‘**Individual Components**’
  ![](../Pictures/Screenshot 2020-11-30 120448.png)
  ![](../Pictures/Screenshot 2020-11-30 120522.png)
11. Scroll to the bottom and make certain ‘**Windows 10 SDK**’ is installed

  ![](../Pictures/Screenshot 2020-11-17 222749.png)
...
64. Or launch a Dev command prompt (via Visual Studio 2019):
	...
	![](../Pictures/Screenshot 2020-12-17 113140.png)

66. Create a basic application (`HelloWorld.java`):
...
116. Measure Startup Time (_in PowerShell_):
